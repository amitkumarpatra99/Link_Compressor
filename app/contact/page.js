...
const contact = () => {
  return (
    <div>
      ...
      <h2 className='w-full text-center font-bold '> Contact Us For any kind of Problem  like <span className='text-blue-600'>  URL Shortner </span>  or any other problem related to this website </h2>
